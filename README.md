# Exercícios Python
Este repositório tem como objetivo reunir alguns exercícios para estudar e reforçar conhecimentos na linguagem Python. Todos os exercícios contam com um enunciado e com uma solução proposta, porém cada pessoa pode implementar a solução da maneira que achar mais interessante.

Os exercícios foram divididos em dois níveis: **básico** e **avançado**. Mesmo que o seu nível de conhecimento na linguagem seja básico, ainda assim você encontrará desafios que seja capaz de concluir. Dentro de cada nível, existem diversas categorias de exercícios para praticar conhecimentos.

Neste repositório, também encontrará algumas sugestões de projetos para unir todos os conhecimentos adquiridos com os exercícios.
...
- Não ver a solução antes de tentar (exercite a sua lógica e criatividade);
- Não copie código... digitando aprendemos mais!
- Evite utilizar LLMs (ChatGPT, GEMINI ou outros) pois a ideia é aprender a programar e não copiar e colar.
